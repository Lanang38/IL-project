  ...
  return (
    ...
    >
      <Link to={to} className="flex items-center">
        {icon}
        <span className={`overflow-hidden transition-all duration-200 ease-in-out ${expanded ? "w-52 ml-3" : "w-0"}`}>
          {text}
        </span>
        {alert && (
          <div
      ...
      {!expanded && (
        <div
          className={`absolute left-full rounded-md px-2 py-1 ml-6
            ...
            invisible opacity-20 -translate-x-3 transition-all duration-500 ease-in-out
